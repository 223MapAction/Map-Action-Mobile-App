...
export default class ChoicePasswordModal extends Component {
  ...
  submit = () => {
    ...
    this.Schema.validate({ password, email }, { abortEarly: false })
      .then(async () => {
        ...
        try {
          this.props.onDone(password, email);
          this.props.onHide();
        } catch (e) {
  ...
  render() {
    const withEmail = !this.props.email;
    return (
      <Modal
        animationType="slide"
        transparent={true}
      ...
      >
        ...
        >
          ...
          >
            ...
            {withEmail && this.renderInput("email", "Email")}
