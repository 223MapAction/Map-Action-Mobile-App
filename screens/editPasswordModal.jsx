  ...
  submit = () => {
    ...
    this.Schema.validate({ password }, { abortEarly: false })
      .then(async () => {
        ...
        try {
          // axios.post(URL+'/api/userUpdate/'+this.props.user._id,{ password })
          //     .then(() => {
          //         Toast.showSuccess("Données modifiées")
          //         this.setState({loading: false})
          //         this.props.onHide()
          //     })
          //     .catch(ex => {
          //         Toast.showSuccess("Erreur lors de la modification des données")
          //         this.props.onHide()
          //         console.log(ex)
          //     })
          this.props.onHide();
